...
const amrex::Vector<DiagnosticDescriptor>& catalog_storage ()
{
    static const amrex::Vector<DiagnosticDescriptor> catalog{
        ...
        {DiagnosticID::E7ESensibleHeatEnergyAccum, "e7e_sensible_heat_energy_accum", "Cumulative applied surface sensible heat energy", "J m^-2", DiagnosticCategory::SurfaceFlux, MissingPolicy::FillMinus999WhenUnavailable},
        {DiagnosticID::E7ELatentHeatEnergyAccum, "e7e_latent_heat_energy_accum", "Cumulative applied surface latent heat energy", "J m^-2", DiagnosticCategory::SurfaceFlux, MissingPolicy::FillMinus999WhenUnavailable},
        {DiagnosticID::E7EXMomentumImpulseAccum, "e7e_x_momentum_impulse_accum", "Cumulative applied x-momentum surface impulse", "N s m^-2", DiagnosticCategory::SurfaceFlux, MissingPolicy::FillMinus999WhenUnavailable},
        {DiagnosticID::E7EYMomentumImpulseAccum, "e7e_y_momentum_impulse_accum", "Cumulative applied y-momentum surface impulse", "N s m^-2", DiagnosticCategory::SurfaceFlux, MissingPolicy::FillMinus999WhenUnavailable},
